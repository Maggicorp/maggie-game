...
/***/ function(module, exports, __webpack_require__) {
	...
	var boardEvents = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var winsArray = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isFree = function isFree(idNum, arr) {
	  if (arr[idNum] === '') {
	    return true;
	  } else {
	    return false;
	...
	var whoWon = function whoWon(arr) {
	...
	var updateGame = function updateGame(index, value, gameOver) {
	  api.updateGame(index, value, gameOver).then(ui.updateGameSuccess).catch(ui.updateGameFailure);
	};

	var turn = [1];

	var playX = function playX(ind, arr, obj) {
	  arr[ind] = 'x';
	  $(obj).text('X');
	};
	...
	var playO = function playO(ind, arr, obj) {
	  arr[ind] = 'o';
	  $(obj).text('O');
	};
	...
	var onBoardClick = function onBoardClick(event) {
	  ...
	  var idNum = $(box).attr('data-id');
	  var freeSpot = isFree(idNum, gameArray);
	  var val = '';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var printGames = function printGames(data) {
	  var newArray = [];
	...
	var oneGameSuccess = function oneGameSuccess(response) {
	...
	var oneGameFailure = function oneGameFailure() {
	...
	var gameOutcome = function gameOutcome(data) {
	  var arr = data.game.cells;
	...
	var didXwin = function didXwin(data) {
	  var result = ['0', '7'];
	  for (var i = 0; i < data.games.length; i++) {
	    var arr = data.games[i].cells;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateGame = function onCreateGame() {
	  event.preventDefault();
	  api.createNew().then(board.newGameSuccess).catch(board.newGameFailure);
	};

	var onGetAllGames = function onGetAllGames() {
	  event.preventDefault();
	  api.getAllGames().then(ui.getGameSuccess).catch(ui.getGameFailure);
	};

	var onGetOneGame = function onGetOneGame(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.getOneGame(data).then(ui.oneGameSuccess).catch(ui.oneGameFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "ee712e20260afcf509132a62eed133ca.png";
